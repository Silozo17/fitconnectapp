...
const socialPlatforms = [
  { key: "instagram_url" as const, label: "Instagram", icon: Instagram, color: "hover:text-pink-500" },
  { key: "facebook_url" as const, label: "Facebook", icon: Facebook, color: "hover:text-blue-600" },
  { key: "youtube_url" as const, label: "YouTube", icon: Youtube, color: "hover:text-red-600" },
  { key: "tiktok_url" as const, label: "TikTok", icon: TikTokIcon, color: "hover:text-foreground" },
  { key: "x_url" as const, label: "X", icon: XIcon, color: "hover:text-foreground" },
  { key: "threads_url" as const, label: "Threads", icon: ThreadsIcon, color: "hover:text-foreground" },
  { key: "linkedin_url" as const, label: "LinkedIn", icon: Linkedin, color: "hover:text-blue-700" },
];
