    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <DashboardSectionHeader 
          title={t("automations.milestones.title", "Milestone Celebrations")}
          description={t("automations.milestones.description", "Automatically celebrate client achievements")}
          className="mb-0"
        />
        <Button 
          variant="outline"
      ...
      {/* Milestone Items - flat bordered divs, NOT cards */}
