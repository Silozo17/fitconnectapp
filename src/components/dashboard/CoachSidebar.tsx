  ...
  return (
    <TooltipProvider>
      ...
      <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
        <SheetContent side="left" className="w-72 p-0 flex flex-col overflow-visible" showCloseButton={false} onOpenAutoFocus={(e) => e.preventDefault()}>
          {/* Logo */}
          <div className="p-4 border-b border-sidebar-border safe-top-sidebar">
            <div className="flex items-center gap-3">
