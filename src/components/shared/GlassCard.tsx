...
import { CardBackgroundCircles } from "./CardBackgroundCircles";
...
interface GlassCardProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  withGlow?: boolean;
  /** Add depth circles behind the card */
  withDepthCircles?: boolean;
  /** Depth circles variant */
  circlesVariant?: "single" | "double" | "triple" | "scattered";
  /** Card variant */
  variant?: "default" | "elevated" | "interactive" | "subtle" | "premium";
  /** Header actions slot */
  ...
  (
    {
      ...
      withGradient = false,
      withGlow = false,
      withDepthCircles = false,
      circlesVariant = "double",
      variant = "default",
      headerAction,
      noPadding = false,
      children,
    ...
    const variantMap = {
      ...
      premium: "glass-elevated" as const,
    };
    ...
    return (
      <div className="relative">
        ...
        <Card
          ...
          className={cn(
            noPadding && "[&>div]:p-0",
            variant === "premium" && "glass-card-elevated",
            className
          )}
          {...props}
        >
