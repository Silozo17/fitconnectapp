    ...
    >
      ...
      <CardFooter className="p-4 pt-0 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <UserAvatar name={bundle.coach_profiles?.display_name || "Coach"} src={bundle.coach_profiles?.profile_image_url} size="sm" />
      ...
      <CardFooter className="p-4 pt-0 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-muted-foreground truncate max-w-[100px]">
            {bundle.coach_profiles?.display_name || "Unknown"}
          </span>
        </div>
        <div className="text-right">
          {bundle.original_price && bundle.original_price > bundle.price && (
