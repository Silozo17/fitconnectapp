    ...
    <nav className={cn("fixed top-0 left-0 right-0 z-50 transition-all duration-300", isScrolled ? "bg-background/90 backdrop-blur-xl shadow-soft border-b border-border/50" : "bg-transparent")}>
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          {/* Desktop Navigation - now shows at lg (1024px) instead of md (768px) */}
          ...
          {/* Desktop Auth Buttons - now shows at lg (1024px) */}
          ...
          {/* Mobile Menu Trigger - now shows until lg (1024px) */}
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            <SheetTrigger asChild>
              <button className="lg:hidden p-2 text-foreground rounded-lg hover:bg-secondary transition-colors">
            ...
            <SheetContent side="right" className="w-[300px] sm:w-[350px] p-0 overflow-y-auto">
              <div className="flex flex-col py-6">
                ...
                <div className="border-t border-border/50 mt-3 pt-6 flex flex-col gap-3 px-6">
                  {user ? (
                    <>
