  ...
  return (
    <div className={`group card-glow rounded-2xl overflow-hidden hover-lift relative ${coach.is_sponsored ? "ring-2 ring-primary/50" : ""}`}>
      ...
      <div className="relative aspect-[4/3] overflow-hidden bg-secondary">
        ...
        <div className="w-full h-full flex items-start justify-center pt-[5px] overflow-hidden bg-gradient-to-br from-cyan-400 via-emerald-400 to-lime-400">
            <img 
              src={getAvatarImageUrl(coach.avatars.slug)} 
              alt={coach.display_name || "Coach"} 
              className="h-[250%] w-auto object-contain object-top"
            />
          </div>
        ) : (
