...
export default function GymAdminEditMember() {
  ...
  useEffect(() => {
    if (member) {
      form.reset({
        ...
        marketing_source_other: member.marketing_source_other || "",
  ...
  const onSubmit = async (values: MemberFormValues) => {
    ...
    try {
      ...
      navigate(`/gym-admin/${gymId}/members/${memberId}`);
    } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" asChild>
          <Link to={`/gym-admin/${gymId}/members/${memberId}`}>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex items-center justify-end gap-4">
            <Button type="button" variant="outline" asChild>
              <Link to={`/gym-admin/${gymId}/members/${memberId}`}>Cancel</Link>
            </Button>
