...
export default function ClientMarketplaceProduct() {
  ...
  const { data: product, isLoading } = useDigitalProduct(productSlug || "");
  const { data: reviews } = useProductReviews(productSlug || "");
  const { data: hasPurchased } = useHasPurchased(productSlug);
  ...
  const handlePurchase = async () => {
    if (!user) {
      navigate("/auth?redirect=/dashboard/client/marketplace/" + productSlug);
      return;
    }
    ...
    const params = new URLSearchParams({
      ...
      itemId: product?.id || "",
      returnUrl: `/dashboard/client/marketplace/${productSlug}`,
    });
    ...
    return (
      <ClientDashboardLayout>
        <div className="flex flex-col items-center justify-center min-h-[60vh]">
          ...
          <Button onClick={() => navigate("/dashboard/client/marketplace")}>Back to Marketplace</Button>
        </div>
      </ClientDashboardLayout>
    );
  }
  ...
  return (
    <ClientDashboardLayout>
      <div className="space-y-6">
        ...
        <Button
          variant="ghost"
          onClick={() => navigate("/dashboard/client/marketplace")}
          className="mb-2"
        >
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div 
                    ...
                    onClick={() => navigate(`${coachLinkPrefix}/${product.coach_profiles?.username || product.coach_id}`)}
                  >
                    <UserAvatar
