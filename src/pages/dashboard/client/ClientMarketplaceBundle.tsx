...
export default function ClientMarketplaceBundle() {
  ...
  if (isLoading) {
    return (
      <ClientDashboardLayout title="Loading..." description="Loading bundle details">
  ...
  if (!bundle) {
    return (
      <ClientDashboardLayout title="Bundle Not Found" description="The bundle you're looking for doesn't exist">
  ...
  return (
    <ClientDashboardLayout title={bundle.title} description={bundle.description || "Digital bundle"}>
