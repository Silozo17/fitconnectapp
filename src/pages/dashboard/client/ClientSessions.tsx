...
const ClientSessions = () => {
  ...
  const SessionCard = ({ session }: { session: Session }) => {
    ...
    return (
      <ContentSection colorTheme="primary" className="p-6 hover:shadow-float transition-all duration-300">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3 text-muted-foreground">
            ...
            <span className="font-medium text-foreground">{format(new Date(session.scheduled_at), "PPP")}</span>
          </div>
          <div className="flex items-center gap-3 text-muted-foreground">
            ...
            {session.is_online ? (
              <div className="flex items-center justify-between w-full">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-foreground">{t('sessions.online')}</span>
                </div>
              ...
              <>
                ...
                <span className="font-medium text-foreground">{session.location || t('sessions.inPerson')}</span>
              </>
            )}
          </div>
        </div>
      ...
      <div className="space-y-11">
        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[1, 2, 3, 4].map((i) => (
              <ContentSection key={i} colorTheme="primary" className="p-6 space-y-4">
