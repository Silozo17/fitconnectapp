-- Update the create_lead_on_new_message function to also create a connection_request
-- when a client sends their first message to a coach (if one doesn't already exist)
