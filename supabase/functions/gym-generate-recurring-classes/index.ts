        ...
        if (!existingDates.has(dateKey)) {
          ...
          if (classStartTime >= now || 
            ...
            classesToCreate.push({
              ...
              waitlist_capacity: templateClass.waitlist_capacity || 0,
              credits_required: templateClass.credits_required || 1,
              booking_opens_hours_before: templateClass.booking_opens_hours_before || 168,
              booking_closes_hours_before: templateClass.booking_closes_hours_before || 0,
              cancellation_deadline_hours: templateClass.cancellation_deadline_hours || 2,
              room: templateClass.room,
              status: "scheduled",
